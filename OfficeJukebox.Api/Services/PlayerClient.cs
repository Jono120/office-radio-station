...
public interface IPlayerClient
{
    ...
    Task<HttpResponseMessage> QueueTrackAsync(QueueTrackRequest request, CancellationToken cancellationToken = default);
    Task<HttpResponseMessage> GetNowPlayingAsync(CancellationToken cancellationToken = default);
    Task<HttpResponseMessage> VetoAsync(Guid id, VetoRequest request, CancellationToken cancellationToken = default);
    Task<HttpResponseMessage> SkipAsync(Guid id, SkipRequest request, CancellationToken cancellationToken = default);
    Task<HttpResponseMessage> GetDevicesAsync(string provider, CancellationToken cancellationToken = default);
    Task<HttpResponseMessage> SetDeviceAsync(SetDeviceRequest request, CancellationToken cancellationToken = default);
}
...
public sealed class PlayerClient(HttpClient httpClient) : IPlayerClient
{
    ...
    public Task<HttpResponseMessage> QueueTrackAsync(QueueTrackRequest request, CancellationToken cancellationToken = default) =>
    ...
    public Task<HttpResponseMessage> VetoAsync(Guid id, VetoRequest request, CancellationToken cancellationToken = default) =>
        httpClient.PostAsJsonAsync($"/queue/{id}/veto", request, cancellationToken);

    public Task<HttpResponseMessage> SkipAsync(Guid id, SkipRequest request, CancellationToken cancellationToken = default) =>
    ...
    public Task<HttpResponseMessage> SetDeviceAsync(SetDeviceRequest request, CancellationToken cancellationToken = default) =>
